...
def train():
    ...
    neg_pred = (z[negative_edge_index[0]] * z[negative_edge_index[1]]).sum(dim=-1)
...
def evaluate():
    ...
    with torch.no_grad():
        ...
        neg_pred = (z[negative_edge_index[0]] * z[negative_edge_index[1]]).sum(dim=-1).sigmoid()
